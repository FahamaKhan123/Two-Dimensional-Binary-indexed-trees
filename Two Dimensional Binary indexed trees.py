class FenwickTree:
    ...
    def Sum_Result(self, x1, y1, x2, y2):                    # A function to print the sum of sub matric query
        ...
        return "The Sum of the submatrix of the given co ordinates:{:8}".format(x.Querying(x1, y1, x2, y2))
...
class FenwickTree2:
    ...
    def Product(self, x1, y1, x2, y2):                       # x1 and y1 co-ordinates of bottom left
        ...
        return (
            ((self.prod(x2, y2))// ((self.prod(x1 - 1, y2)* self.prod(x2, y1-1))) * self.prod(x1-1, y1 - 1))
                 )
    ...
    def Prod_Result(self, x1, y1, x2, y2):                   # A function to print the product of sub matric query
        self.Construct(matrix)
        return "The product of the submatrix of the given co ordinates:{:5}".format(y.Product(x1, y1, x2, y2))
...
if __name__ == "__main__":
    ...
    print("\tThe Matrix is:\n")
    x.Print()
    print(x.Sum_Result(1, 1, 3, 2))
    print(y.Prod_Result(1, 1, 3, 2))